...
public class Main {
	...
	public static void eliminarFichero() throws IOException {
		...
		nombre = sc.nextLine();
		File ruta = new File("C:\\Users\\formacion\\eclipse-workspace\\Ficheros");
	...
	public static void escribirFicheroJava7sinAnaydir() {
		Scanner sc = new Scanner(System.in);
		String cadena;
		try (PrintWriter salida = new PrintWriter("C:\\\\Users\\\\formacion\\\\eclipse-workspace\\\\Ficheros\\\\datos.txt")) {
			System.out.println("Introduce texto. Para acabar introduce la cadena FIN:");
			cadena = sc.nextLine();
			while (!cadena.equalsIgnoreCase("FIN")) {
				salida.println(cadena);
	 ...
	 * @return
	 */
	public static void guardarFicheroenListaJava7() {
		...
		for(int i=0;i<ficherodevuelto.size();i++) {
	...
	private void modificarsFicheroenListaJava8() {
				Scanner sc= new Scanner(System.in);
				System.out.println("Introduzca el nombre: ");
				String persona= sc.nextLine();
				
		try {
			List<String> lines = Files.readAllLines(Paths.get("./datos.txt"), Charset.defaultCharset());
			int total=0;
			int numero=0;
			//System.out.println(lines.toString());
			for(String line:lines) {
				if(line.toLowerCase().contains(persona.toLowerCase())) {
					total += Integer.parseInt(line.substring(line.lastIndexOf(';')+1));
					numero++;
				}
				
			}
			System.out.println(numero!=0?"La nota media es "+String.format("%.2f",(double)total/numero):"no existe");
	...
	public static String[] leerdirectior(String dir) throw IOException{
		File dirr=new File(dir);
		
		
	}
	private void ahorros() throws IOException{
		
		File directorio = new File("C:/Users/formacion/Desktop/aaa");
		// directorio actual
		String[] lista = directorio.list();
		Scanner sc= new Scanner(System.in);
...
try {
	...
	List<String> lines = Files.readAllLines(Paths.get("C:/Users/formacion/Desktop/aaa/"+lista[j]), Charset.defaultCharset());
	...
	System.out.println(numero!=0?"Dinero total "+String.format("%.2f",(double)total):"no existe");
} catch (Exception e) {
	e.printStackTrace();
}
		
}
	public static void leersScanner(String d) {
