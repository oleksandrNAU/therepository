...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2018 a las 22:56:30
...
--
ALTER TABLE `datos_usuario`
  ADD CONSTRAINT `datos_usuario_ibfk_1` FOREIGN KEY (`id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
